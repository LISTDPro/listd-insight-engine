    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      {role === "clerk" ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          <Card className="hover:shadow-sm cursor-pointer transition-shadow" onClick={() => navigate("/dashboard/admin")}>
            <CardContent className="p-4">
              <div className="w-9 h-9 rounded-lg bg-accent/10 flex items-center justify-center mb-3">
                <Briefcase className="w-4 h-4 text-accent" />
              </div>
              <h3 className="text-sm font-semibold text-foreground mb-0.5">Daily Checklist</h3>
          ...
          <Card className="hover:shadow-sm cursor-pointer transition-shadow" onClick={() => navigate("/dashboard/admin")}>
            <CardContent className="p-4">
              ...
              <h3 className="text-sm font-semibold text-foreground mb-0.5">Users & Verification</h3>
              <p className="text-[11px] text-muted-foreground">Manage users, approve clerks, handle disputes</p>
            </CardContent>
          </Card>
          <Card className="hover:shadow-sm cursor-pointer transition-shadow" onClick={() => navigate("/dashboard/payments")}>
            <CardContent className="p-4">
              <div className="w-9 h-9 rounded-lg bg-success/10 flex items-center justify-center mb-3">
                <Plus className="w-4 h-4 text-success" />
              </div>
              <h3 className="text-sm font-semibold text-foreground mb-0.5">Payments</h3>
