    ...
    <div className="px-3 py-3 border-t border-sidebar-border flex items-center gap-2">
      {instagramUrl && (
        <a
          ...
          className="flex items-center justify-center w-8 h-8 rounded-lg text-sidebar-foreground/40 hover:text-sidebar-foreground hover:bg-sidebar-accent transition-colors"
