...
const tiers: Tier[] = [
  {
    ...
    startingPrice: 55,
    icon: Shield,
    description: "Standard ASTs and lower dispute probability properties. Tribunal-ready, digitally signed, audit-trailed reports.",
    outcomes: [
  ...
  },
  {
    ...
    icon: Zap,
    popular: true,
    description: "Professional agencies managing mixed portfolios. Enhanced documentation depth with faster delivery.",
    outcomes: [
  ...
  },
  {
    ...
    startingPrice: 100,
    icon: Crown,
    description: "High-value properties and dispute-sensitive tenancies. Maximum documentation depth with same-day turnaround.",
    outcomes: [
